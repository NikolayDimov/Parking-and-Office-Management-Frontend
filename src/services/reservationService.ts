...
const getCurrentReservationsByUserId = async (
  id: string | undefined
): Promise<Reservation[]> => {
  const response = await get(
    `${endpoints.getCurrentReservationsByUser}${id}`,
    {}
  );
  return response;
};

const getFutureReservationsByUserId = async (
  id: string | undefined
): Promise<Reservation[]> => {
  const response = await get(
    `${endpoints.getFutureReservationsByUser}${id}`,
    {}
  );
  return response;
};
...
const getFutureReservationsByUserIdAndLocation = async (
  ...
  const response = await get(
    `${endpoints.getFutureReservationsByUserAndLocation}${userId}/${locationId}`,
    {}
  );
  return response;
};
...
const getResevationsBySpot = async (spotId: string): Promise<Reservation[]> => {
  const response = await get(
    `${endpoints.getResevationsBySpotId}/${spotId}`,
    {}
  );
  return response;
};
...
const createReservation = async ({
  reservations,
}: MultipleReservations): Promise<MultipleReservations> => {
